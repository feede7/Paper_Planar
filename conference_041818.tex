...
En el marco del Tomógrafo por Emisión de Positrones Argentino (AR-PET), el módulo que mayor desarrollo VHDL en FPGA está integrado en el procesamiento de eventos de la cámara Gamma. Cada una de estas se compone de 48 FotoMultiplicadores (PMT), de 2"x2" en grilla de 6x8, adheridos con grasa óptica a un cristal contínuo de Ioduro de Sodio (NaI) de 30cmx40cm. Cada uno de estos detecta los centelleos del cristal cada vez que un fotón impacta en él, luego de preamplificarlo de manera analógica y digitalizarlo con una detección y caracterización en tiempo y energía de pulsos en Spartan-3, y así las 48 señales son recibidas por la Artix-7 que junta todo y bajo un simple control temporal conforma los eventos sumando energías y posicionando como centro de masas pesado por energía (Anger). De esta manera se notificará como salida de cada cámara Gamma la caracterización en tiempo. energía y geográfico de cada fotón que impacte en la cámara, usando esto luego para triangularlo y encontrar posibles conincidencias.
...
El procesamiento planar cuenta con 48 entradas LVDS por las que cada Spartan-3 envía información cada 1us de energía detectada y marca temporal de la misma. Cada 1us, el procesamiento planar tiene que decidir si la información que está recibiendo corresponde todos al mismo evento. Para esto se utiliza una ventana temporal de 1ns para determinar el aporte individual de cada PMT en referencia a la marca temporal del que en ese momento obtuvo la mayor energía. Esta acumulación energética estará relacionada con la cantidad de luz en el centelleo del cristal detectada al mismo momento por varios PMTs. La acumulación de la historia de estas respuestas generan espectros energéticos similares al siguiente

FOTO DE ESPECTRO de PMT independientes y conjunto (todo sin calibrar)
...
FOTO DE ESPECTRO de PMT independientes y conjunto (todo calibrado)
